				...
				{#each filteredMaquinarios as maq (maq.id)}
					...
					>
						<div class="flex gap-4 p-4">
							...
							<div class="relative z-10 shrink-0" data-inventory-menu>
								<button
									type="button"
								...
								{#if openMenu === maq.id}
									<ul
										role="menu"
										tabindex="-1"
										class="absolute right-0 top-full z-50 m-0 mt-1 w-48 list-none rounded-xl border border-gray-200 bg-white p-0 py-1 shadow-2xl"
									>
										<li role="none">
											<a
												role="menuitem"
